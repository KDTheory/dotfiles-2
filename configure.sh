...
then
    ...
    if [[ $? -eq 0 ]]
    then
        echo "Successfully configured your environment with KDTheory's dotfiles..."
    else
        echo "KDTheory's dotfiles were not applied successfully..." >&2
fi
else 
	echo ''
    echo "You chose not to apply KDTheory WSL dotfiles. You will need to configure your environment manually..."
	echo ''
